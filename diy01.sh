...
#merge_packae 25.12.5 https://github.com/BeeconMini/openwrt target/linux/mediatek/filogic/base-files/etc/board.d target/linux/mediatek/filogic/base-files/etc/board.d/02_network
#merge_packae 25.12.5 https://github.com/BeeconMini/openwrt target/linux/mediatek/filogic/base-files/lib/upgrade target/linux/mediatek/filogic/base-files/lib/upgrade/platform.sh
#merge_packae 25.12.5 https://github.com/BeeconMini/openwrt target/linux/mediatek/image target/linux/mediatek/image/filogic.mk

## autocore automount default-settings
merge_packae master https://github.com/immortalwrt/immortalwrt package/emortal package/emortal/default-settings
